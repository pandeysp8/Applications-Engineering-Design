...
public class ProdManagementPanel extends javax.swing.JPanel {
    ...
    public ProdManagementPanel(JPanel panel , ProductDirectory accDir) {
        initComponents();
        this.accDir = accDir;
        this.panel=panel;
    }
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        CreateProductJPanel createPanel= new CreateProductJPanel(this.panel,accDir);
        this.panel.add("CreateProductJPanel",createPanel);
    ...
    private void btnManageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageActionPerformed
        // TODO add your handling code here:
        ManageProdPanel managePanel= new ManageProdPanel(this.panel,accDir);
        this.panel.add("ManageProdPanel",managePanel);
        CardLayout layout=(CardLayout) this.panel.getLayout();
        layout.next(panel);
